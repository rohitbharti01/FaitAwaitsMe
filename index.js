...
!(function (t) {
  function e(e) {
    for (
      var o, a, u = e[0], c = e[1], f = e[2], p = 0, s = []; p < u.length; p++
    )
      (a = u[p]), r[a] && s.push(r[a][0]), (r[a] = 0);
  ...
  25: function (t, e, n) {
      ...
      Object(s.a)(
        (r =
          o(
            (r = (function (t) {
              function e() {
                return v(this, e), O(this, w(e).apply(this, arguments));
              }
              return m(e, a["a"]), e;
            })())
          ) || r)
    ...
    var P = new u.a("Coming soon...", {
      color: "#ffffff",
      size: (y.a.isMobile, 0.2),
      wireframe: !1,
      opacity: 1,
    });
    (P.position.x = -P.basePosition * (y.a.isMobile ? 0.5 : 0.55)),
    (P.position.y = y.a.isMobile ? -1.2 : -0.9),
    (P.position.z = 2),
    (P.rotation.x = -0.1);
    var _ = ["#0011ff", "#f2f3f7"].map(function (t) {
          ...
          (o = [{
            ...
            value: function () {
              if (!(this.lines.length > 150)) {
                for (
                  var t = -1,
                    n = Math.random() > 0.8 ? 0.1 : 0.3,
                    o = Object(f.a)(0, 2 * Math.PI),
                    r = []; t < g.camera.position.z;
                ...
                d(w(e.prototype), "addLine", this).call(this, {
                  visibleLength: Object(f.a)(0.2, 0.8),
                  points: r,
                  speed: Object(f.a)(0.001, 0.005),
                  color: Object(l.a)(_),
                  width: Object(f.a)(0.01, 0.06),
                });
              }
            },
          }, ]) && b(n.prototype, o),
